...
let callback1Called: boolean = false;
let callback2Called: boolean = false

// первый коллбэк
const listener1 = (data): void => {
    console.log('Listener 1 called with data:', data);
    callback1Called = true;
};

// второй коллбэк
const listener2 = (data): void => {
...
try {
    ...
    console.log(`Test 5 failed: Deleting unsubscribed listener - error: ${e}`)
}
